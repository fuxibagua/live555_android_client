	...
	if (parseEBMLVal_binary(size, codecPrivate)) {
	  ...
	  if (track != NULL) {
		...
		if (codecPrivateSize < 23 || (codecPrivate[13]&0xF0) != 0xF0 ||
		  ...
		  // Byte 21 of the 'codecProxy private' data contains 'lengthSizeMinusOne':
